...
iris.data = hstack(
    (
     choice([0, 1, 2], size=iris.data.shape[0]+1).reshape(-1,1),
     vstack((iris.data,
...
step2 = ('FeatureUnionExt', FeatureUnion(transformer_list=[step2_1, step2_2, step2_3]))
#新建无量纲化对象
...
pipeline = Pipeline(steps=[step1, step3, step4, step5, step6])
